...
class Node:
    ...
    def is_closed(self):
        return self.colour == Colour.RED  # returns true or false

    def is_open(self):
        return self.colour == Colour.GREEN  # returns true or false

    def is_barrier(self):
        return self.colour == Colour.BLACK  # returns true or false

    def is_start(self):
        return self.colour == Colour.ORANGE  # returns true or false

    def is_end(self):
        return self.colour == Colour.TURQUOISE  # returns true or false
...
def algorithm(draw, grid, start, end):
    ...
    f_score[start] = heuristic_manhattan(start.get_pos(), end.get_pos())
    ...
    while not open_set.empty():
        ...
        for neighbour in current.neighbours:
            ...
            if temp_g_score < g_score[neighbour]:
                ...
                f_score[neighbour] = temp_g_score + heuristic_manhattan(neighbour.get_pos(), end.get_pos())
            ...
            if pygame.mouse.get_pressed()[0]:  # LEFT click
                ...
                if event.key == pygame.K_SPACE and start and end:
                    ...
                    algorithm(lambda: draw(win, grid, ROWS, width), grid, start,
                              end)  # using lamda to pass draw function as an argument to algorithm
